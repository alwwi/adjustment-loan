...
public class LoanRequestNeedApprovalDTO {
    //requestCategory
    ...
    public LoanRequestNeedApprovalDTO()
    {
        super();
    }

    public LoanRequestNeedApprovalDTO(LoLoanRequest requestData, RequestCategoryType requestCategoryType, DataApproval dataApproval, VwEmpAssignment vwEmpAssignment, String approverName, String serverNamePath, LoLoanCategory llc , String secret) {
        this(requestData, requestCategoryType, dataApproval, vwEmpAssignment, null, approverName, serverNamePath, llc ,secret);
    }

    public LoanRequestNeedApprovalDTO(LoLoanRequest requestData, RequestCategoryType requestCategoryType, DataApproval dataApproval, VwEmpAssignment vwEmpAssignment, AttachmentDataApproval attachmentDataApproval, String approverName, String serverNamePath, LoLoanCategory llc, String secret) {
        super();
    ...
    public LoanRequestNeedApprovalDTO(LoLoanRequest requestData,RequestCategoryType requestCategoryType,DataApproval dataApproval, VwEmpAssignment vwEmpAssignment,AttachmentDataApproval attachmentDataApproval,String approverName,String serverNamePath, VwEmpAssignment empRqst , LoLoanCategory llc, String secret) {
        this(requestData, requestCategoryType, dataApproval, vwEmpAssignment, attachmentDataApproval, approverName, serverNamePath, llc, secret);
