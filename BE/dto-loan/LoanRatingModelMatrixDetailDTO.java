...
public class LoanRatingModelMatrixDetailDTO {
    private String id;
    ...
    public LoanRatingModelMatrixDetailDTO() {
    }

    public LoanRatingModelMatrixDetailDTO(String id, String loanRatingModelId, String paRatingId1, String paRatingId2, String result, String loanRatingModelName, String paRatingName1, String paRatingName2) {
        this.id = id;
