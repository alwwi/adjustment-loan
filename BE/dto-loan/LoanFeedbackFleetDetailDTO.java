...
public class LoanFeedbackFleetDetailDTO {
    private String id;
    private String name;
    ...
    public LoanFeedbackFleetDetailDTO() {
    }

    public LoanFeedbackFleetDetailDTO(String id, String name, String description, String loanCategoryId, String syncElementName, String valueSource, Boolean isActive, LocalDateTime startDate, LocalDateTime endDate, String loanCategoryName, Integer sequenceNo) {
        this.id = id;
        this.name = name;
