...
public class AllowanceBracketListDTO {
    ...
    public AllowanceBracketListDTO(String id,LocalDateTime startDate, LocalDateTime endDate, String name, String description, String loanCategoryId, String organizationId, String organizationGroupId, String positionId, String positionLevelId, String jobTitleId, String jobFamilyId, String workLocationType, String companyOfficeId, String gradeId, String employmentStatus, String ratingId, Double value,
                                 String elementName, Integer multiplier,Double totalElementValue, String syncElementName) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.loanCategoryId = loanCategoryId;
