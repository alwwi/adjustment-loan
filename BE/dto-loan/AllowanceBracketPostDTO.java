...
public class AllowanceBracketPostDTO {
    private String id;
    ...
    public AllowanceBracketPostDTO() {
    }

    public AllowanceBracketPostDTO(String id, LocalDateTime startDate, LocalDateTime endDate, String name, String description, String loanCategoryId, String organizationId, String organizationGroupId, String positionId, String positionLevelId, String jobTitleId, String jobFamilyId, String workLocationType, String companyOfficeId, String gradeId, String employmentStatus, String ratingId, Double value, Integer multiplier, String elementName, String syncElementName) {
        this.id = id;
