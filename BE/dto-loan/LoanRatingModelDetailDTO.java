...
public class LoanRatingModelDetailDTO {
    private String id;
    private String name;
    ...
    public LoanRatingModelDetailDTO() {
    }

    public LoanRatingModelDetailDTO(String id, String name, LocalDateTime startDate, LocalDateTime endDate, String description, String paRatingId, Integer yearBefore, String loanCategoryId, String paRatingName) {
        this.id = id;
        this.name = name;
