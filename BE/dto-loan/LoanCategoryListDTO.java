...
public class LoanCategoryListDTO {
    private String id;
    private String name;
...
//    public LoanCategoryListDTO(String id, String name, LocalDateTime startDate, LocalDateTime endDate, Integer occurenceLimit, Boolean isSimulation, String description) {
//        this.id = id;
//        this.name = name;
...
//    }
    ...
    public LoanCategoryListDTO(String id, String name, LocalDateTime startDate, LocalDateTime endDate, Integer occurenceLimit, Boolean isSimulation, String description, Integer approvalLevelFleet,
                               String requestCategoryTypeId, String requestCategoryTypeName) {
        this.id = id;
        this.name = name;
        this.startDate = startDate;
        this.endDate = endDate;
