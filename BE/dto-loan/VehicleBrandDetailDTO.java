...
public class VehicleBrandDetailDTO {
    private String id;
    private String name;
    ...
    public VehicleBrandDetailDTO(String id, String name, LocalDateTime startDate, LocalDateTime endDate, String description, String vehicleTypeId, String vehicleTypeName,
