...
public class LoanTypeListDTO {
    ...
    public LoanTypeListDTO(String id, String name, LocalDateTime startDate, LocalDateTime endDate, String description, String loanCategoryId, Double dsrPercentage, Integer minTenor, Integer maxTenor, Double interestRate, Boolean isEarlySettlement, Boolean isDownPayment) {
        this.id = id;
        this.name = name;
